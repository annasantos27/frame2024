    ...
    return <>
        ...
        <Container>
            ...
            <div class="row">
                ...
                <Card titulo={produto.titulo}descricao={produto.descricao}preco={produto.preco.toLocaleString
...
export async function getServerSideProps() {
    ...
    const res = await fetch('https://frame2024.vercel.app/api/produtos/data')
